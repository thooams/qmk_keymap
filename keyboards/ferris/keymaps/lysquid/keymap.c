...
[SPC] = LAYOUT(
    ...
    KF_SUP2,    KF_BDOT,    KF_IQES,    KF_LARW,    KF_RARW,    KF_LDQT,    KF_RDQT,    KF_MICR,    KF_PSMS,    KF_CROS,
...
[SPC2] = LAYOUT(
    KF_AE,      KF_EACU,    KF_EGRV,    KF_SUP2,    KF_LDQT,    KF_RDQT,     KF_UGRV,    KF_PSMS,    KF_OE,      KF_DEG,
